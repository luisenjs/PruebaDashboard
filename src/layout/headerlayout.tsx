...
export function HeaderLayout() {
    return (
        <div className="bg-white z-1000 flex items-center text-white px-5 py-4 shadow-lg shadow-gray-200">
            <span className="text-black text-2xl font-semibold w-2/12 text-center"><span className="text-red-400">Dash</span>board</span>
            <div className="flex grow px-10">
                <input className="shadow-lg shadow-gray-200 rounded-lg w-full px-2 placeholder:text-gray-400" type="text" placeholder="Search your task here..." />
